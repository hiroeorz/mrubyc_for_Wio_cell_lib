...
static void class_bme680_get_sensor_data_with_addr(mrb_vm *vm, mrb_value *v, int argc)
{
  ...
  mrbc_value temp_value = mrb_float_value(vm, (mrbc_float)temp);
  mrbc_value humi_value = mrb_float_value(vm, (mrbc_float)humi);
  mrbc_value press_value = mrb_float_value(vm, (mrbc_float)press);
  mrbc_value gas_value = mrb_float_value(vm, (mrbc_float)gas);
