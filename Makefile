...
MRBC=mrbc
SRC=./mrblib/bmp280.rb ./mrblib/bme680.rb ./mrblib/json_generator.rb ./mrblib/json_parser.rb ./mrblib/mqtt_client.rb \
    ./mrblib/serial_uart.rb ./mrblib/sht35.rb ./mrblib/wio.rb ./mrblib/modbus_rtu.rb
